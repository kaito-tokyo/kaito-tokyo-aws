...
export class ImportedControlTowerGroupsStack extends cdk.Stack {
	...
	constructor(scope: Construct, id: string, props: ImportedControlTowerGroupsStackProps) {
		...
		this.accountFactory = new identitystore.CfnGroup(this, "ControlTowerAdmins", {
			displayName: "AWSAccountFactory",
			identityStoreId
		});

		this.logArchiveViewers = new identitystore.CfnGroup(this, "ControlTowerAdmins", {
			displayName: "AWSLogArchiveViewers",
			identityStoreId
		});

		this.serviceCatalogAdmins = new identitystore.CfnGroup(this, "ControlTowerAdmins", {
			displayName: "AWSServiceCatalogAdmins",
			identityStoreId
		});

		this.securityAuditors = new identitystore.CfnGroup(this, "ControlTowerAdmins", {
			displayName: "AWSSecurityAuditors",
			identityStoreId
		});

		this.logArchiveAdmins = new identitystore.CfnGroup(this, "ControlTowerAdmins", {
			displayName: "AWSLogArchiveAdmins",
			identityStoreId
		});

		this.auditAccountAdmins = new identitystore.CfnGroup(this, "ControlTowerAdmins", {
			displayName: "AWSAuditAccountAdmins",
			identityStoreId
		});

		this.securityAuditPowerUsers = new identitystore.CfnGroup(this, "ControlTowerAdmins", {
